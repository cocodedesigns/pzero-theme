 ...
 class TweetPHP {
    ...
    public function  __construct ($options = array()) {
      ...
      array(
          ...
          'twitter_template'      => '<div class="twitter-wrapper">{tweets}</div>',
          'tweet_template'        => '
            <div class="lotus-tweet lotus-tweet-wrap">
              <p class="lotus-tweet-date"><a href="{link}" target="_blank"><span class="lotus-tweet-icon fa fa-twitter"></span>
                Posted <span class="lotus-tweet-date">{date}</span></a></p>
              <p class="lotus-tweet-status">{tweet}</p>
            </div>
          ',
