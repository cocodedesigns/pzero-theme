 ...
 */
add_action( 'cmb2_admin_init', 'ccdClient_themeSettings_page_siteheader' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function ccdClient_themeSettings_page_siteheader() {
	/**
	 * Registers options page menu item and form.
     */

  	$prefix = '_ccdclient_themesettings_siteheader_';
	$cmb = new_cmb2_box( array(
		'id'           => 'ccdClient_themeSettings_page_siteheader',
		'title'        => esc_html__( 'Site Header', 'ccdclient-wp' ),
		'object_types' => array( 'options-page' ),
		/*
		 * The following parameters are specific to the options-page box
		 * Several of these parameters are passed along to add_menu_page()/add_submenu_page().
		 */
		'option_key'      => 'ccdtheme_settings_siteheader', // The option key and admin menu page slug.
  ...
  $cmb->add_field( array(
		'name' => __( 'Header Logo', 'ccdclient-wp' ),
		'id' => $prefix . 'logo_title',
		'type' => 'title',
	) );

	$cmb->add_field( array(
		'name' => __( 'Select Main Logo', 'ccdclient-wp' ),
	...
	$cmb->add_field( array(
		'name' => __( 'Select Secondary Logo', 'ccdclient-wp' ),
		'id' => $prefix . 'scroll_logo_image',
		'type' => 'file',
		'preview_size' => 'thumbnail',
		'options' => array(
			'url' => false,
