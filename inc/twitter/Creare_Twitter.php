...
class Creare_Twitter
{
	...
	public function getTweets($tweets)
	{
		...
		{	
            ...
            $t[$i]["screen_name"] = trim($tweet->user->screen_name);
            $t[$i]["display_name"] = trim($tweet->user->name);
 	...
 	public function getLatestTweets()
	{
		...
		$latesttweets = $twitterconn->get("https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=".$this->screen_name."&count=".$this->not."&exclude_replies=".$this->repliesoff."");		
